 ...
 * @file
 */
#ifndef GERMPLASM_SERVICE_LIBRARY_H
#define GERMPLASM_SERVICE_LIBRARY_H
...
*/
  ...
  #ifdef GERMPLASM_LIBRARY_EXPORTS /* defined if we are building the LIB DLL (instead of using it) */
    #define GERMPLASM_SERVICE_API LIB_HELPER_SYMBOL_EXPORT
  #else
    #define GERMPLASM_SERVICE_API LIB_HELPER_SYMBOL_IMPORT
  #endif /* #ifdef GERMPLASM_LIBRARY_EXPORTS */
  #define GERMPLASM_SERVICE_LOCAL LIB_HELPER_SYMBOL_LOCAL
...
#endif		/* #ifndef GERMPLASM_SERVICE_LIBRARY_H */
